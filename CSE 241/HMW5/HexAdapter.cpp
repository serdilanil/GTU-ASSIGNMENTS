...
void HexAdapter<T>::play(){   //In this function played from computer.(non -parameter).
...
template<template <typename...> class T>
void HexAdapter<T>::play(const Cell& State){
...
template<template <typename...> class T>
void HexAdapter<T>::playGame(){  //In this function, we select size,game type in briefly we start the game here.
...
template<template <typename...> class T>
void HexAdapter<T>::reset(){     //In this function, I made my assignments in the cell class.
...
template<template <typename...> class T>
void HexAdapter<T>::print(int winFlag){  //I set up this function to print the table with its point, x and letter o.
    char ch1 = 'x';
    char ch2 = 'o';
    int i,j;
    int counter = 1;
...
template<template <typename...> class T>
void HexAdapter<T>::userGame(){   //Function to get the player input and update the board.
...
template<template <typename...> class T>
void HexAdapter<T>::writeToFile(const string& filename){ //in this function I save the game information in txt file.
...
template<template <typename...> class T>
void HexAdapter<T>::readFromFile(const string& filename){ //I load the saved game in the terminal and I use the const reference parameter in this function.
...
template<template <typename...> class T>
int HexAdapter<T>::winGame_X(int x,int y,int a){  //I used recursive to find the win condition in this function.
...
template<template <typename...> class T>
void HexAdapter<T>::userComputer(){   //in this function Computer and user enter input to the board.
    int number,num;
...
template<template <typename...> class T>
int HexAdapter<T>::operator()(int x,int y)const{
