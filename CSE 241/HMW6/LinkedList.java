...
public class LinkedList<T> implements List<T>,Queue<T>  {
    ...
    /**
     * retrieves the head of this Collection     *
     * @throws NoSuchElementException If Collection is empty
     * @return T returns Collecion's head element
     */
     ...
     * @return boolean returns if adding is successful
     */
    ...
    /**
     * retrieves and removes the head of this Collection
     * @throws NoSuchElementException If Collection is empty
     * @return T returns Collecion's head element
     */
